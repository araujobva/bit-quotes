...
public class VJFrameEditUserCommon extends javax.swing.JFrame {
    ...
    public VJFrameEditUserCommon() {
        initComponents();
        setLocationRelativeTo(null);
    }

    public VJFrameEditUserCommon(String userJComboBox, String user) {
        initComponents();
        this.user = user;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VJFrameEditUserCommon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VJFrameEditUserCommon().setVisible(true);
            }
        });
    }
