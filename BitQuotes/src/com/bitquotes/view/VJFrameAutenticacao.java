 ...
 * @author bruno
 */
public class VJFrameAutenticacao extends javax.swing.JFrame {

    /**
     * Creates new form VJFrameAutenticacao
     */
    public VJFrameAutenticacao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Autenticação", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 17))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VJFrameAutenticacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VJFrameAutenticacao().setVisible(true);
            }
        });
    }
