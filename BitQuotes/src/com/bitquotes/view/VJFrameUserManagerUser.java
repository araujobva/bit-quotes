 ...
 * @author bruno
 */
public class VJFrameUserManagerUser extends javax.swing.JFrame {
    ...
    public VJFrameUserManagerUser() {
        initComponents();
        setLocationRelativeTo(null);
    }
    
    public VJFrameUserManagerUser(String user) {
        initComponents();
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jComboBox1, 0, 676, Short.MAX_VALUE)
                        .addGap(37, 37, 37))))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        VJFrameEditUserCommon screen = new VJFrameEditUserCommon(userJComboBox, this.user);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VJFrameUserManagerUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VJFrameUserManagerUser().setVisible(true);
            }
        });
    }
